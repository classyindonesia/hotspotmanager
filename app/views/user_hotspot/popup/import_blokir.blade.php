...
<h3>Import Blokir User</h3>
{{ Form::open(array('route' => 'user_hotspot.do_import_blokir', 'files' => true)) }}
 {{ Form::file('userfile') }} <br>

 

 <button class='btn btn-success' id='import' type='submit'> <i class='fa fa-cloud-upload'></i> import</button>
 <a class='btn btn-success' href="{{ URL::to('template_import/blokir_user.xls') }}"> 
