 	<legend>Tambah Atribut [Check]</legend>

	<div class="form-group">
		<label for="">Attribute</label>
		<input value='{{ $radreply->attribute }}' type="text" class="form-control" id="attribute" placeholder="attribute...">
	</div>

	<div class="form-group">
		<label for="">OP</label>
		<input value='{{ $radreply->op }}' type="text" class="form-control" id="op" placeholder="op...">
	</div>
	<div class="form-group">
		<label for="">Value</label>
		<input value='{{ $radreply->value }}' type="text" class="form-control" id="value" placeholder="value...">
	</div>	
...
$.ajax({
	url : '{{ URL::route("update_user_check_attributes") }}',
	data : form_data,
	type : 'post',
	error: function(err){
